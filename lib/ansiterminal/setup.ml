...
(* OASIS_START *)
(* DO NOT EDIT (digest: ab6a1558c96afded6705ebb060707a4e) *)
(*
               ...
               post_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("ocaml", ["choose_implementation.ml"])))
                 ];
               };
            ...
            [
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_c_sources = ["ANSITerminal_stubs.c"];
                      bs_data_files = [];
                   ...
                   {
                      lib_modules = ["ANSITerminal"];
                      lib_internal_modules = ["ANSITerminal_common"];
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "API reference for ANSITerminal";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "ANSITerminal"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "showcolors.ml"; })
            ];
          plugins =
