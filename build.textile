...
h2. Building the client for different Architectures

h3. Compiling client on MacOSX/Linux
...
Clone the jark-client repository and compile
...
h3. Cross-compiling client for Win32 on Debian/Ubuntu
